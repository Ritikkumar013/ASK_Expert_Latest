...
const privacypolicy = () => {
  return (
    <>
    <div className='w-full h-[55vh] px-5 md:px-14 md:h-[70vh] flex items-center bg-[url("/1.jpg")] bg-cover bg-center lg:h-[80vh]'>
            ...
            <div className='bg-white text-sm py-14 px-5 md:px-14 '>
                <div className='max-w-screen-xl container mx-auto '>
                    <h1 className='mb-3 text-3xl'>Privacy Policy</h1>
